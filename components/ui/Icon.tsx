...
const PATHS: Record<string, string> = {
  ...
  text: "M7 3h7l4 4v13a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1ZM14 3v4h4M9 12h6M9 16h4",
  ...
  cake: "M4 21h16M5 21v-7a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v7M4 16c1.5 0 1.5 1.2 3 1.2S8.5 16 10 16s1.5 1.2 3 1.2 1.5-1.2 3-1.2 1.5 1.2 3 1.2M9 12V9M12 12V9M15 12V9M9 6.5c0-1 1.5-1.5 1.5-3C10.5 2.7 9.8 2 9 2M15 6.5c0-1-1.5-1.5-1.5-3C13.5 2.7 14.2 2 15 2",
  apple: "M16.36 1.43c.04 1.06-.37 2.09-1.06 2.84-.7.78-1.86 1.38-2.98 1.29-.12-1.04.39-2.13 1.04-2.81.72-.78 1.96-1.36 3-1.32zM20.5 17.2c-.55 1.27-.82 1.84-1.53 2.97-.99 1.57-2.39 3.53-4.12 3.54-1.54.01-1.94-1-4.03-.99-2.09.01-2.53 1.01-4.07.99-1.73-.02-3.05-1.78-4.04-3.35-2.0-2.86-2.29-8.2-.6-11.04 1.07-1.82 2.76-2.88 4.34-2.88 1.62 0 2.64 1.04 3.98 1.04 1.3 0 2.09-1.04 3.97-1.04 1.42 0 2.92.77 3.99 2.1-3.5 1.92-2.93 6.92.62 7.96z",
  image: "M4 4h16a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1ZM3 16l5-5 4 4 3-3 5 5M9 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z",
};

const FILLED = ["play", "flame", "cross", "apple"];
