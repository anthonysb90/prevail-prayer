...
const TOPIC_ICONS: Record<ScriptureTopic, string> = {
  Prayer:    "chatbubble-ellipses-outline",
  ...
  Warfare:   "flash-outline",
  Salvation: "star-outline",
  Hope:      "sunny-outline",
};
        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 12 }}>
          {VERSE_TOPICS.map((topic) => (
            ...
            >
              ...
              />
              <Text
                style={{ fontFamily: "PlayfairDisplay-SemiBold", fontSize: 18, color: "#1A1A1A", marginTop: 12 }}
              >
                {topic}
              </Text>
            </TouchableOpacity>
